...
export function ProjectPage({ projectInfo, CaseStudy }: { projectInfo: Project, CaseStudy: (props: any) => ReactNode }) {
    return (
        <main className="flex flex-col items-center justify-start w-full min-h-screen px-[5vw] pt-10 text-left font-nhgd">
            <div className="flex flex-col items-center justify-start w-full min-h-screen mb-12 max-w-7xl drop-shadow-md">
...
export function ProjectFooter({ projectInfo }: { projectInfo: Project }) {
    return (
        <div className="w-full rounded-[1.25vw] overflow-hidden bg-zinc-900 p-6 text-lg tracking-wide font-semibold text-zinc-100 drop-shadow-md">
            <Link href={'/'} className="rounded-[8px] border-[3px] w-56 border-zinc-700 flex flex-row justify-center items-center p-3.5 gap-2 float-left hover:text-zinc-950 hover:bg-zinc-100 hover:border-zinc-100">
                <svg className="relative block w-6 h-6 -ml-1 fill-current top-" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z" /></svg>
                <p className="">Back to portfolio</p>
            </Link>
            {projectInfo.link ? (
                <Link href={projectInfo.link} className="rounded-[8px] font-bold border-[3px] border-zinc-100 bg-zinc-100 flex flex-row justify-center items-center w-[152px] p-3.5 gap-1.5 float-right hover:bg-zinc-800 text-zinc-950 hover:text-zinc-100">
                    <p className="">Visit site</p>
                    <svg className="relative block w-6 h-6 fill-current top-" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M218.87-135.869q-34.483 0-58.742-24.259t-24.259-58.742v-522.26q0-34.483 24.259-58.742t58.742-24.259H480v83.001H218.87v522.26h522.26V-480h83.001v261.13q0 34.483-24.259 58.742t-58.742 24.259H218.87ZM394.413-336 336-394.413 682.717-741.13H576v-83.001h248.131V-576H741.13v-106.717L394.413-336Z" /></svg>
                </Link>
            ) : ''}
        </div>
    );
        ...
        <div className="w-full tracking-wide text-left mb-14">
            ...
            <div className="mt-3.5 text-xl font-medium tracking-wider">
                {projectInfo.tools.length > 0 ? (
                    <>
                        <svg className="inline ml-0.5 mr-[1px] top-[0.5px] relative fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M360-640h240v-80H360v80ZM80-160v-200h160v40h80v-40h320v40h80v-40h160v200H80Zm0-240v-160q0-33 23.5-56.5T160-640h120v-80q0-33 23.5-56.5T360-800h240q33 0 56.5 23.5T680-720v80h120q33 0 56.5 23.5T880-560v160H720v-80h-80v80H320v-80h-80v80H80Z" /></svg>
