...
export function CaseStudy() {
    return (
        <>
            <SyncedVideos videoSrcs={[main_vid, floor_vid, caption_vid, citation_vid]} classNames={["h-full w-full relative pt-[56.0319%] rounded-[1.25vw] overflow-hidden mb-[3.5%] drop-shadow-md", "min-h-[calc(100vh+5.25rem)] min-w-[100vw] aspect-video pt-[56.25%] fixed -top-20 left-[50%] -translate-x-1/2 fixed -z-20", "h-full w-3/4 relative pt-[13.125%] mx-auto rounded-[1.25vw] overflow-hidden mb-[3.5%] drop-shadow-md bg-black", "h-full w-1/2 relative pt-[6.75%] rounded-[1.25vw] overflow-hidden mb-[32%] mx-auto drop-shadow-md bg-black"]} videoClassNames={['', 'object-fit-cover pointer-events-none', '', '']}></SyncedVideos>
        </>
